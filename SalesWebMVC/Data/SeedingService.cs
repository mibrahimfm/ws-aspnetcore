...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Lucas Alves", "lucas1806@gmail.com", new DateTime(1988, 06, 18), 1220.00, d1);
            Seller s2 = new Seller(2, "Mariana Lima Souza", "marianals@gmail.com", new DateTime(1982, 01, 11), 920.00, d2);
            Seller s3 = new Seller(3, "Carlos Freitas", "clos@icloud.com", new DateTime(1992, 03, 22), 1600.00, d1);
            Seller s4 = new Seller(4, "Marcela Carvalho", "marsoares@gmail.com", new DateTime(1972, 11, 01), 1080.00, d4);
            Seller s5 = new Seller(5, "Raquel Morais", "raquel22@gmail.com", new DateTime(1969, 04, 30), 1705.00, d3);
            Seller s6 = new Seller(6, "Lucio Cabral", "lucabral@gmail.com", new DateTime(1977, 02, 21), 850.00, d2);
